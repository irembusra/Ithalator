...
public class ObjectPoolerTruck : MonoBehaviour {

	private static ObjectPoolerTruck _This;

	public static ObjectPoolerTruck instance
	{
		get
		{
			if(_This == null)
			{
				_This = FindObjectOfType<ObjectPoolerTruck> ().GetComponent<ObjectPoolerTruck> ();
			}
			return _This;
		}
	}
